...
@section('content')
    ...
    <form method="GET" action="{{ route('admin.pendaftaran.index') }}" class="mb-4 flex space-x-2">
        ...
        <button type="submit" class="bg-gray-800 hover:bg-gray-900 text-white px-4 py-2 rounded-lg shadow">
            Cari
        </button>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            @if ($mhs->status == 'pending')
                                <span
                                    class="px-3 py-1 rounded bg-yellow-100 text-yellow-700 text-xs font-medium">Pending</span>
                            @elseif($mhs->status == 'diterima')
                                <span
                                    class="px-3 py-1 rounded bg-green-100 text-green-700 text-xs font-medium">Diterima</span>
                            @else
                        ...
                        <td class="px-6 py-4 flex items-center justify-center space-x-2">
                            ...
                            @else
                                ...
                                <a href="javascript:void(0);"
                                    class="inline-flex items-center px-3 py-1 text-xs font-medium text-blue-700 bg-blue-100 hover:bg-blue-200 rounded">
                                    🔍 Lihat
                                </a>
                            @endif
